...
export default function SignupPage() {
  return (
    <main className="h-screen overflow-hidden flex flex-col relative isolate">
      ...
      <div 
        className="absolute inset-0 -z-10 bg-[url('/signup.jpg')] bg-cover bg-bottom before:absolute before:inset-0 before:bg-gradient-to-b before:from-[#eef5f9]/90 before:via-[#eef5f9]/60 before:to-transparent" 
        aria-hidden="true" 
      />
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="bg-white/80 backdrop-blur-md border border-white/60 rounded-sm p-8 w-full max-w-[420px] shadow-[0_8px_30px_rgba(0,0,0,0.04)] animate-fade-up">
          <div className="text-center mb-6">
            <h1 className="text-[1.75rem] font-bold tracking-tight text-[#1a202c]">Join the Community</h1>
          </div>
          ...
          <div className="mt-8 text-center text-[14px] font-medium text-[#4a5568]">
            ...
            <Link href="/login" className="text-[#1a202c] font-bold hover:underline">
              Log in
            </Link>
          </div>
        </div>
